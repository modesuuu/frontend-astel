            ...
            <div className="flex flex-col gap-8 ">
              {userFeeds.length > 0 ? (
                userFeeds.map((feed) => (
                  <div
                    key={feed._id}
                    className="flex flex-col gap-3 pb-6 border-b border-gray-50 dark:border-gray-900/40 last:border-0"
                  >
                    <Profile
