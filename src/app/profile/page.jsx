...
import MyApplicationsSkeleton from "@/components/profile/MyApplicationsSkeleton.jsx";
import MyAppsSkeleton from "@/components/profile/MyApplicationsSkeleton.jsx";
                  ...
                  userFeeds.map((feed) => (
                    ...
                    >
                      ...
                      <h1
                        ...
                        onClick={() =>
                          router.push(ROUTES.POST_DETAIL(feed?._id))
                        }
                      >
                        View Details
                      </h1>
