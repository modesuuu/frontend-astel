    ...
    <section>
        ...
        <div className="flex items-center w-full h-screen justify-between px-16">
            ...
            <div className="flex flex-col gap-6 justify-center h-full w-full max-w-141.5 items-center">
                ...
                <h1 className="text-primary text-center font-medium max-w-70 text-6xl">Welcome Back</h1>
                ...
                <p className=" text-sm mt-3">Don't have an account? <a href="/auth/register" className="text-primary">Register</a></p>
            </div>
        </div>
    </section>
  )
